...
from config_scgm_deeplabv3_epldiceloss_C import default_config
...
def train(label_loader, unlabel_loader_0, unlabel_loader_1, test_loader, val_loader, learning_rate, weight_decay, num_epoch, model_path, niters_per_epoch):
    ...
    savedir='./tmodel_scgm/1gpu/baseline_instance_deeplabv3_epldiceloss_savebestema_counttime_C/'
