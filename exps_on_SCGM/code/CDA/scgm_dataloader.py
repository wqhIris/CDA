...
from util.utils import im_convert #!!!from utils.utils import im_convert
from util.data_utils import colorful_spectrum_mix, fourier_transform, save_image #!!!from utils.data_utils import colorful_spectrum_mix, fourier_transform, save_image
...
def fourier_augmentation(img, tar_img, mode, alpha):
    ...
    if mode == 'AS':
        ...
        aug_img, aug_tar_img = fourier_transform(img, tar_img, L=0.01, i=0.8)
    elif mode == 'AM':
        # print("using AM mode")
