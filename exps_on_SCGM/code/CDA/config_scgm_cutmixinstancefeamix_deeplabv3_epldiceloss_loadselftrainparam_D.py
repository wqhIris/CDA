...
default_config = dict(
    ...
    Pretrain =False,
    Loadselftrain = True,
    pretrain_file = '/root/autodl-fs/exps_on_SCGM/CDA/tmodel_scgm/1gpu/baseline_instance_deeplabv3_epldiceloss_savebestema_D/stu_SCGM_fixmatch_ratio0.2_D_CM.pt', #'',#'resnet50_v1c.pth', #!!!'/home/hyaoad/remote/semi_medical/MNMS_seg/pretrain_res/resnet50_v1c.pth',
