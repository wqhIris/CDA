...
from networks.conv_2_5d import Conv2_5D_depth, Conv2_5D_disp
...
class SingleNetwork(nn.Module):
    ...
    def __init__(self, num_classes, criterion, norm_layer, default_config, in_channels=1, pretrained_model=None):
