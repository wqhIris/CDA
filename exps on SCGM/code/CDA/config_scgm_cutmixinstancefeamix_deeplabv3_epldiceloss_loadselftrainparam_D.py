...
default_config = dict(
    ...
    num_epoch=50,
    learning_rate=0.001, #!!!0.0001, #!!!0.01, #!!!0.001, #!!!5e-5, #!!!1e-4,            # learning rate of Adam
    ...
    Pretrain =False,
    Loadselftrain = True,
    pretrain_file = '/root/autodl-fs/EPL_usecovidnetwork/tmodel_scgm/1gpu/baseline_instance_deeplabv3_epldiceloss_savebestema_D/stu_SCGM_fixmatch_ratio0.2_D_CM.pt', #'',#'resnet50_v1c.pth', #!!!'/home/hyaoad/remote/semi_medical/MNMS_seg/pretrain_res/resnet50_v1c.pth',
