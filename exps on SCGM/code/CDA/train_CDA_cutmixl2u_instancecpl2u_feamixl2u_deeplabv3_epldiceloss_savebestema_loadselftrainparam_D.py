...
from config_scgm_cutmixinstancefeamix_deeplabv3_epldiceloss_loadselftrainparam_D import default_config
...
def train(label_loader, unlabel_loader_0, unlabel_loader_1, test_loader, val_loader, learning_rate, weight_decay, num_epoch, model_path, niters_per_epoch):
    ...
    savedir='./tmodel_scgm/1gpu/cutmixl2u_instancecpl2u_feamixl2u_deeplabv3_epldiceloss_savebestema_loadselftrainparam_D/v2_nousepseudoloss_lr{}wdecay{}_alpha0.9_ema0.9_seed14/'.format(config['learning_rate'], config['weight_decay'])
    ...
    for epoch in range(num_epoch):
        ...
        for idx in pbar:
            ...
            mix_alpha=0.9 #!!!0.9 #!!!0.4 #1.0 #0.9 #0.4
            ...
            if epoch <= 3:
                ...
                loss = labeled_loss_1 + pseudo_supervision_aug1+pseudo_supervision_aug2 + pseudo_supervision_aug3  #！！！pseudo_supervision_aug1+pseudo_supervision_aug2 + pseudo_supervision_aug3  #!!!pseudo_supervision + pseudo_supervision_aug1+pseudo_supervision_aug2 + pseudo_supervision_aug3  
